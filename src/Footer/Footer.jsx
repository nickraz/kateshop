...
const Footer = () => {
    return (
        <div className={`container ${css.footer}`} data-container="container">
            ...
            <div className="col-sm-3">
                <h4>Контакты</h4>
                <p><i class="fa fa-map-marker" aria-hidden="true"></i> ул.Магомедтагирова, дом 156 Махачкала, Республика Дагестан, Россия, 367009</p>
                <p className={css.phone}><a href="tel:+79382000277"><i class="fa fa-phone" aria-hidden="true"></i> 8 (938) 200-02-77</a></p>
            </div>
            <div className="col-sm-3">
